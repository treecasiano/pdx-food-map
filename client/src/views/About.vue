      ...
      <v-flex>
        <v-card class="ma-3 pa-3 primary--text">
          ...
          <v-card-text>
            ...
            <p>
              A food desert is a generally defined as a neighborhood that lacks
              sources of healthy food, typically measured in ways that take into
              account supermarket accessibility, individual resources, and
              neighborhood-level resources.
            </p>
            <p>
              The USDA classifies a census tract as being a food desert if it is
              "low income" and has "low access." These food access indicators
              ...
              <li>
                ...
                <ol>
                  <li>
                    ...
                    live more than ½ mile from a supermarket (10 miles if in a
                    rural area)
                  </li>
                  <li>
                    Low-income AND at least 500 people OR 33% of the population
                    live more than 1 mile from a supermarket (or 10 miles if in
                    a rural area)
                  </li>
                  <li>
                    Low-income AND at least 500 people or 33% of the population
                    live more than 2 miles from a supermarket (or 20 miles if in
                    a rural area)
                  </li>
                  <li>
                    Low-income and at least 100 households are more than ½ mile
                    from a supermarket and have no vehicle access OR at least
                    500 people or 33% of the population > 20 miles away from a
                    supermarket, regardless of their vehicle access status.
                  </li>
                </ol>
              </li>
            </ul>
            <p class="mt-1">
              The PDX Food Map categorizes a census tract as a food desert based
              on the first criteria noted above (a low income tract with at
              least 500 people OR 33% of the population living more than 1/2
            ...
            <v-card-text>
              <ul style="padding: 0;">
                <li>
                  ...
                  <p>
                    The grocery store dataset used in the map was initially
                    seeded with
                    <a
                ...
                <li>
                  <h3>Census Tracts</h3>
                  <p>
                    A shapefile with all the census tracts in the
                ...
                <li>
                  ...
                  <p>
                    Pedestrian and Bike Trails for Clark County, WA was
                    retrieved from
                    <a
