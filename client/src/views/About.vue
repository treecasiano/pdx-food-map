          ...
          <v-card-text class="text-left">
            ...
            <ul>
              ...
              <li>
                ...
                <ol>
                  <li>1) Low-income AND at least 500 people OR 33% of the popolation live more than ½ mile from a supermarket (10 miles if in a rural area)</li>
              ...
              <ul style="padding: 0;">
                <li>
                  ...
                  <p>
                    ...
                    >open data from the City of Portland</a>, which provided approximately 105 records for Portland only. Another 162 records were added by the map author to cover the entire MSA.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    >farmers market dataset</a> was also obtained from the City of Portland, to which additional farmers markets from the rest of the study area have been added.
                  </p>
                </li>
                <li>
                  <strong>Census Tracts</strong>
                  <p>
                  ...
                  <p>
                    ...
                    >Data from the United States Department of Agriculture Economic Research Service Food Access Research Atlas</a> (2017) was joined to the census tract records.
                  </p>
                </li>
              </ul>
            </v-card-text>
