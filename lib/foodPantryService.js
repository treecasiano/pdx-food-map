...
FROM ${table}
  ...
  async function search(searchParams) {
    ...
    const query = `SELECT gid, location_name, street_address_1, street_address_2, city, state, zip, hours_of_operation, website, phone ST_Distance(geom, ref_geom) AS distance
FROM ${table}
